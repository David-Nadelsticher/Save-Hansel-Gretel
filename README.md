# <img width="1536" height="733" alt="SaveHanselAndGretel" src="https://github.com/user-attachments/assets/6a8f5d59-fb53-4ca7-be87-44ca1ac73014" />
## Save Hansel & Gretel

A fast‑paced 2D single‑player side‑scroller where you play as the Fire Warrior, racing against the clock to rescue Hansel and Gretel from an evil witch in the depths of the Dark Forest.
...
- **Responsive Controls:** Run and roll .  
- **Attack Animations & Cooldowns:** Clear visual and timing cues for sword and flame attacks.  
- **Feedback:** Collecting breads triggers satisfying visual and auditory effects.
...
*Get ready to light the way, slice through darkness, and race the clock in Save Hansel & Gretel!*  
